...
pref("security.apps.privileged.CSP.default", "default-src * data: blob:; script-src 'self' http://127.0.0.1:8081 http://local-device.kaiostech.com:8081; object-src 'none'; style-src 'self' 'unsafe-inline'");
...
// For v2.5, we enable "dom.subsidylock.enabled to true" to support subsidy
// lock w/o sim case.
pref("dom.subsidylock.enabled", true);
...
pref("dom.secureelement.ace.enabled", false);
#endif

...
pref("security.apps.certified.CSP.default", "default-src * data: blob:; script-src 'self' app://theme.gaiamobile.org; object-src 'none'; style-src 'self' 'unsafe-inline' app://theme.gaiamobile.org app://shared.gaiamobile.org");
...
pref("apps.serviceCenter.devOrigins", "https://api.test.kaiostech.com,https://api.stage.kaiostech.com,https://storage.test.kaiostech.com,https://storage.stage.kaiostech.com,http://storage.test.kaiostech.com,http://storage.stage.kaiostech.com,https://api.prod.kaiostech.com,https://storage.prod.kaiostech.com");
